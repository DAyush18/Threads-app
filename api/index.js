...
mongoose
  .connect("mongodb+srv://ayush:ayush@cluster0.4fqrg.mongodb.net/", {
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "techforgames985@gmail.com",
      pass: "prjygvsxfsewrhvl",
    },
  });
  ...
  const mailOptions = {
    ...
    text: `please click the following link to verify your email http://192.168.1.4:3000/verify/${verificationToken}`,
  };
